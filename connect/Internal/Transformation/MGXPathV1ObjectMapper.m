...
void nsFormatDate (xmlXPathParserContextPtr ctxt, int nargs);
...
- (id) initWithObjectClass: (Class) anObjectClass objectAllocationBlock: (id (^)(void)) objectAllocationBlockOrNil objectMapping: (NSDictionary *) anObjectMapping objectRoot: (NSString *) anObjectRootOrNil {
...
- (NSArray *) map: (NSData *)data {
    ...
    xmlXPathRegisterFuncNS(xPathCtx, (const xmlChar *) "dateTime", (const xmlChar *) "http://www.mobilegridinc.com/ns/mg", nsFormatDate);
    xmlXPathRegisterFuncNS(xPathCtx, (const xmlChar *) "dateTime", (const xmlChar *) NULL, nsFormatDate);
...
//    printf("dateTime(%s) called\r", format);
