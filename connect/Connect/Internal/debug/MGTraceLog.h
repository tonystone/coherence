...
#define LogTrace(level,...) [MGTraceLog logMessage: [self class] classInstance: self selector: _cmd sourceFile: __FILE__ sourceLineNumber: __LINE__ logLevel: MGLogLevelTrace1 + ((int)level) - 1   message: [NSString stringWithFormat:__VA_ARGS__]]
