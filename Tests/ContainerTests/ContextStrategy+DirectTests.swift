//
//  ContextStrategy+DirectTests.swift
///
...
class ContextStrategyDirectTests: XCTestCase {

    let container = GenericPersistentContainer<ContextStrategy.Direct>(name: "ContainerTestModel1")
