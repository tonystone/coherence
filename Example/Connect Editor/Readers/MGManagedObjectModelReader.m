...
@interface MGManagedObjectModelParserDelegate : NSObject <NSXMLParserDelegate>

    - (NSManagedObjectModel *) model;

@end

@implementation MGManagedObjectModelReader

    + (NSManagedObjectModel *) managedObjectModelFromURL: (NSURL *) aModelURL {

        NSURL * contentsURL = [self modelContentsURLFromModelURL: aModelURL];
        
        MGManagedObjectModelParserDelegate * delegate = [[MGManagedObjectModelParserDelegate alloc] init];
...
@implementation MGManagedObjectModelParserDelegate {
        NSManagedObjectModel      * model;
