...
public class Application extends javax.ws.rs.core.Application {
    ...
    public Set<Class<?>> getClasses() {
        ...
        classes.add(RegionsRegionIdCountriesResourceController.class);
        classes.add(CountriesResourceController.class);
        classes.add(DepartmentsDepartmentIdEmployeesResourceController.class);
        classes.add(DepartmentsResourceController.class);
        classes.add(EmployeesEmployeeIdJobHistoryResourceController.class);
        classes.add(EmployeesResourceController.class);
        classes.add(JobsResourceController.class);
//        classes.add(LocationsLocationIdEmployeesResourceController.class);
