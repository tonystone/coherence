...
protocol WebServiceDescription {
     ...
     */
    var address: NSURLComponents { get }
     ...
     */
    func parametersForAction(action: String) -> [String : AnyObject]

    /*
     */
    func argumentsForAction(action: String) -> [String : AnyObject]
...
extension WebServiceDescription {
    ...
    var inputSerialization: String {
        get { return MGWSDLHTTPExtensionValueSerializationURLEncoded }
    }
    

    var outputSerialization: String {
        get { return MGWSDLHTTPExtensionValueSerializationJSON }
    }
