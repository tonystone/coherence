...
#define LogError(...)       [MGTraceLog logMessage: [self class] classInstance: self selector: _cmd sourceFile: __FILE__ sourceLineNumber: __LINE__ logLevel: MGLogLevelError   message: [NSString stringWithFormat:__VA_ARGS__]]
#define LogWarning(...)     [MGTraceLog logMessage: [self class] classInstance: self selector: _cmd sourceFile: __FILE__ sourceLineNumber: __LINE__ logLevel: MGLogLevelWarning message: [NSString stringWithFormat:__VA_ARGS__]]
#define LogInfo(...)        [MGTraceLog logMessage: [self class] classInstance: self selector: _cmd sourceFile: __FILE__ sourceLineNumber: __LINE__ logLevel: MGLogLevelInfo    message: [NSString stringWithFormat:__VA_ARGS__]]
#define LogTrace(level,...) [MGTraceLog logMessage: [self class] classInstance: self selector: _cmd sourceFile: __FILE__ sourceLineNumber: __LINE__ logLevel: (MGLogLevel) MGLogLevelTrace1 + ((int)level) - 1   message: [NSString stringWithFormat:__VA_ARGS__]]
